  ...
  <div class="container">
    <div class="formulario">
      ...
      <div class="header">
        ...
        <h3>Iniciar sesión como finanzas</h3>
      </div>
    ...
    <div class="input-group">
        ...
        <a href="inicio3.php" class="btn btn-registrar btn-profesional">Iniciar sesión como cocina</a>
        <a href="inicio4.php" class="btn btn-registrar btn-profesional">Iniciar sesión como bodega</a>
    </div>
</form>
